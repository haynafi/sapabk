    ...
    <section>
        ...
        >
            <div>
                ...
                <div class="mt-1 block w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-md text-gray-700 font-mono">
                    {{ user.nip }}
                </div>
                <p class="mt-1 text-sm text-gray-500">{{ t('auth.nip_readonly') }}</p>
            </div>
