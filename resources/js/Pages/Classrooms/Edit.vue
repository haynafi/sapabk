...
const form = useForm({
    ...
    quiz_template_id: props.classroom.quiz_template_id || '',
});
            ...
            <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                    <form @submit.prevent="submit" class="p-4 sm:p-6 space-y-6">
                        ...
                        <div>
                            <InputLabel :value="t('classrooms.unit_code')" />
                            <div class="mt-1 p-3 bg-gray-50 rounded-md">
                                <code class="text-lg font-mono text-indigo-600">{{ classroom.unit_code }}</code>
                            </div>
                            <p class="mt-1 text-sm text-gray-500">
                                {{ t('classrooms.share_code') }}
                            </p>
                        </div>
